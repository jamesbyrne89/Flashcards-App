...
function hideMenu () {
	...
	tl3.to(menu3, 0.1, {opacity: 0}).to(menu3, 0, {display: 'none'});
}
TweenLite.to(line1, 0.3, {height: '0px', x: 0});
...
function menuTransition() {
	...
	tl.to(slider, 0.5, {width: '100vw'})
	.to(slider, 0.7, {opacity: 0, delay: 0.3})
	.to(slider, 0, {display: 'none'});
		TweenLite.to(line1, 0.2, {height: '0'});
	TweenLite.to(line2, 0.2, {height: '0'});
	TweenLite.to(menu, 0, {display: 'none'});
	TweenLite.to(menu2, 0, {display: 'none'});
}
...
function showCategoryInput () {
  ...
  <h2 class="menu__header">Categories</h2>
	...
	// Fade out main menu
TweenLite.to(line1, 0.7, {height: '100vh', delay: 1.2});
