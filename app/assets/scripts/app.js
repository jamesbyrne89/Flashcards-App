...
document.addEventListener("DOMContentLoaded", function() {
		...
		flashcardsDB.addNewCard = function(c) {
		...
		menuBtn.addEventListener('click', showMenu); menuOverlay.addEventListener('click', hideMenu, false); addCategoryBtn.addEventListener('click', function(e) {
